...
const storeExterior = { url: "/sass-luxe-reveal/__l5e/assets-v1/a749e35c-102a-491d-85be-6845e3219743/store-exterior.jpg" };;
const reception = { url: "/sass-luxe-reveal/__l5e/assets-v1/e811e2f2-fd2b-4860-9df8-58e1fcfef789/reception.jpg" };;
const stylingArea = { url: "/sass-luxe-reveal/__l5e/assets-v1/8fcd7246-00cd-4f84-af82-4e4a56efc9a8/styling-area.jpg" };;
const kidsStyling1 = { url: "/sass-luxe-reveal/__l5e/assets-v1/6c2dcb30-665c-474c-a870-bdc19160716d/kids-styling-1.jpg" };;
const hairWashStation = { url: "/sass-luxe-reveal/__l5e/assets-v1/a9151512-ad9d-4480-9683-595c77c8ab93/hair-wash-station.jpg" };;
const spaRoom = { url: "/sass-luxe-reveal/__l5e/assets-v1/ac0471b1-e635-46e3-a8b7-e395551e095b/spa-room.jpg" };;
const studioCorridor = { url: "/sass-luxe-reveal/__l5e/assets-v1/0b77c207-fff3-46ab-9738-9c61080c3fae/studio-corridor.jpg" };;
const kidsStyling2 = { url: "/sass-luxe-reveal/__l5e/assets-v1/4fa81412-9954-447a-9c84-c03128df26d6/kids-styling-2.jpg" };;
...
const why1 = { url: "/sass-luxe-reveal/__l5e/assets-v1/ace34086-8966-4eb3-b7c3-e96f7642165f/why-1.svg" };;
const why2 = { url: "/sass-luxe-reveal/__l5e/assets-v1/4a533a23-45b0-42d3-accf-fe46ebf4cad8/why-2.svg" };;
const why3 = { url: "/sass-luxe-reveal/__l5e/assets-v1/75f19b6f-e57e-4b7a-9dfa-f86d873e2b63/why-3.svg" };;
const why4 = { url: "/sass-luxe-reveal/__l5e/assets-v1/b64a5033-462f-4cc7-aed8-f0aa5a4882c1/why-4.svg" };;
const why5 = { url: "/sass-luxe-reveal/__l5e/assets-v1/113b2422-50e8-4d65-8256-f3899da6d167/why-5.svg" };;
const why6 = { url: "/sass-luxe-reveal/__l5e/assets-v1/c97d4720-ab82-4298-b7f9-aa816fd8b6ac/why-6.svg" };;
const why7 = { url: "/sass-luxe-reveal/__l5e/assets-v1/bc609fe1-a221-4de0-abc4-2dbb843b9331/why-7.svg" };;
const why8 = { url: "/sass-luxe-reveal/__l5e/assets-v1/7f27c310-44d4-44f9-ab73-0cd599d82ce4/why-8.svg" };;
