...
const storeExterior = { url: getAssetUrl("/__l5e/assets-v1/a749e35c-102a-491d-85be-6845e3219743/store-exterior.jpg") };
const reception = { url: getAssetUrl("/__l5e/assets-v1/e811e2f2-fd2b-4860-9df8-58e1fcfef789/reception.jpg") };
const stylingArea = { url: getAssetUrl("/__l5e/assets-v1/8fcd7246-00cd-4f84-af82-4e4a56efc9a8/styling-area.jpg") };
const kidsStyling1 = { url: getAssetUrl("/__l5e/assets-v1/6c2dcb30-665c-474c-a870-bdc19160716d/kids-styling-1.jpg") };
const hairWashStation = { url: getAssetUrl("/__l5e/assets-v1/a9151512-ad9d-4480-9683-595c77c8ab93/hair-wash-station.jpg") };
const spaRoom = { url: getAssetUrl("/__l5e/assets-v1/ac0471b1-e635-46e3-a8b7-e395551e095b/spa-room.jpg") };
const studioCorridor = { url: getAssetUrl("/__l5e/assets-v1/0b77c207-fff3-46ab-9738-9c61080c3fae/studio-corridor.jpg") };
const kidsStyling2 = { url: getAssetUrl("/__l5e/assets-v1/4fa81412-9954-447a-9c84-c03128df26d6/kids-styling-2.jpg") };
...
const reel1 = { url: getAssetUrl("/__l5e/assets-v1/06ee9068-cfe1-4dff-aab0-4e6694d66458/transformation-1.mp4") };
const reel2 = { url: getAssetUrl("/__l5e/assets-v1/a5974689-9d32-40bc-b7aa-aae102dfd29a/transformation-2.mp4") };
const reel3 = { url: getAssetUrl("/__l5e/assets-v1/4fc3f559-398a-405c-92d0-366e8d39921f/transformation-3.mp4") };
const reel4 = { url: getAssetUrl("/__l5e/assets-v1/11e5ce91-dc4b-49a9-bbf4-922cf3914521/transformation-4.mp4") };
const poster1 = { url: getAssetUrl("/__l5e/assets-v1/ee2947a9-7de2-406b-9853-a4eac369e36f/trans-poster-1.jpg") };
const poster2 = { url: getAssetUrl("/__l5e/assets-v1/a29c4b8a-0d41-42a9-bff4-cdd5e3a4d7f6/trans-poster-2.jpg") };
const poster3 = { url: getAssetUrl("/__l5e/assets-v1/2195d8a4-4b1f-4704-9b4f-c018cdcceb26/trans-poster-3.jpg") };
const poster4 = { url: getAssetUrl("/__l5e/assets-v1/b1f1c67d-e5d4-412d-920d-5a4c007677fc/trans-poster-4.jpg") };
