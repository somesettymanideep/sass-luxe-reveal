...
const employeesIcon = { url: "/__l5e/assets-v1/bbf14a41-3c84-4830-bab8-91470a9213ae/employees.svg" };;
const productsIcon = { url: "/__l5e/assets-v1/35e7c426-3686-4a80-8867-d9a6452735ea/why-products.svg" };;
const consultationIcon = { url: "/__l5e/assets-v1/b98acddf-f33e-4ac5-8bdf-b1be95f04e3e/consultation.svg" };;
const safeIcon = { url: "/__l5e/assets-v1/2038b92b-1f8b-4f85-b6fc-e811b82c8d28/why-safe.svg" };;
const consumerIcon = { url: "/__l5e/assets-v1/70bca972-cd35-4195-b670-adec1ce7273f/why-consumer.svg" };;
