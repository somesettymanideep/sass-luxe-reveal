...
import fashionColours from "@/assets/hero-colours.jpg?url";
import bridalBanner from "@/assets/hero-bride.jpg?url";
import mensBanner from "@/assets/hero-mens.jpg?url";

const slides = [
  {
    image: fashionColours,
